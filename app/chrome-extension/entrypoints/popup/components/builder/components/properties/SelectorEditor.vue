<template>
  <div class="form-section">
    <div class="section-header">
      <span class="section-title">{{ title || 'المحدد' }}</span>
      <button v-if="allowPick" class="btn-sm btn-primary" @click="pickFromPage">اختيار من الصفحة</button>
    </div>
    <div class="selector-list" data-field="target.candidates">
      ...
      <button class="btn-sm" @click="add">+ إضافة محدد</button>
    </div>
  </div>
</template>
