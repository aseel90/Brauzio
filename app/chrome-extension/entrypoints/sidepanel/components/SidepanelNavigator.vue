<template>
  ...
  >
    ...
    <button
      ...
      title="切换الصفحة（可سحب وإفلات移动，双击重置位置）"
    >
      <svg
          ...
          <div class="navigator-items">
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">المساعد الذكي</span>
                <span class="navigator-item-desc">محادثات ومهام وكيل الذكاء الاصطناعي</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">إدارة سير العمل</span>
                <span class="navigator-item-desc">تسجيل وتشغيل مهام الأتمتة</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">إدارة تحديد العناصر</span>
                <span class="navigator-item-desc">إدارةالصفحةالعنصرتحديد</span>
              </div>
